...
namespace ComicShelf.DataAccess.Migrations
{
    ...
    [Migration("20190221182735_FixRelations")]
            ...
            modelBuilder.Entity("ComicShelf.DataAccess.Entities.UserCollection", b =>
                {
                    ...
                    b.HasOne("ComicShelf.DataAccess.Entities.ComicCollection", "ComicCollection")
                        .WithMany("UserCollection")
                        .HasForeignKey("ComicCollectionId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
